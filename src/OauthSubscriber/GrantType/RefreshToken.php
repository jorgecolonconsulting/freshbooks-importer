...
namespace _2UpMedia\FreshbooksImporter\OauthSubscriber\GrantType;
    ...
    */
    protected function getPostBody($refreshToken)
    {
        if (Helper::guzzleIs('>=', '6')) {
            ...
            return \GuzzleHttp\Psr7\stream_for(\GuzzleHttp\json_encode($data));
        }
